...
describe('SubOrderController', () => {
  let controller: SubOrder_Controller;
  let service: SubOrder_Service;
  ...
  beforeEach(async () => {
    ...
    controller = module.get<SubOrder_Controller>(SubOrder_Controller);
    service = module.get<SubOrder_Service>(SubOrder_Service);
  });
